...
class ChemicalSystemsReader(abc.ABC):
    ...
    of :class:`~dipm.data.chemical_system.ChemicalSystem` objects,
    ...
    def load(
        self,
        postprocess_fun: PostProcessFun | None = filter_systems_with_unseen_atoms_and_assign_atomic_species,
    ) -> ChemicalSystemsBySplit:
        ...
        Args:
            postprocess_fun: Function to call to postprocess the loaded dataset
                            ...
                            :meth:`~dipm.data.chemical_systems_readers.utils.assign_atomic_species_and_filter_systems_with_unseen_atoms`
