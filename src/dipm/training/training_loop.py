...
class TrainingLoop:
    ...
    def _get_number_of_batches_graphs_and_nodes(
        ...
        logger.info(
            "Warmup scan of %s dataset done. Total number of graphs: %s, total number of nodes: "
            "%s, total number of batches: %s",
            name, total_num_graphs, total_num_nodes, total_num_batches,
        )
