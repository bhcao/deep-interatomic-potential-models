...
The `model` section contains the following parameters:

* `target`: The name of the model class in `dipm.models` to use.
...
* `loss`: The name of the loss function class in :py:mod:`dipm.loss` to use.
